...
@dataclass
class BaseModelOutputWithPastAndPreFFNHidden(BaseModelOutputWithPast):
    """
...
@dataclass
class CausalLMOutputWithPastAndPreFFNHidden(CausalLMOutputWithPast):
    """
    Base class for causal language model's outputs that may also contain a pre-ffn hidden state.
...
@dataclass
class SequenceClassifierOutputWithPastAndPreFFNHidden(SequenceClassifierOutputWithPast):
    """
    Base class for sequence classifier model's outputs that may also contain a pre-ffn hidden state.
